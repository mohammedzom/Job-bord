        ...
        <nav class="bg-gray-800">
                ...
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="relative ml-4 flex items-center md:ml-6">
                            <button type="button" command="--toggle" commandfor="desktop-notifications"
                            ...
                            <div id="desktop-notifications" hidden
                                class="absolute right-0 top-full mt-2 w-80 rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none z-50">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-white/10 pt-4 pb-3">
                    ...
                    <button type="button" command="--toggle" commandfor="mobile-notifications"
                    ...
                    <div id="mobile-notifications" hidden class="mt-3 space-y-1 px-2">
                        <div
